...
public class BuilderMazos {
    public Mazo crearMazoGuerrero() {
        ...
        mazoGuerrero.agregarCarta(
                new Carta("Triturar", "Daño 3, Inflige 2 Vulnerable", 3, new DañoNormal(3), null, new Vulnerable(3),
                        null));
        ...
        mazoGuerrero.agregarCarta(
                new Carta("Oportunista", " Roba cartas igual al daño que hagas este turno", 1, null, null, null, null)); // TODO

        mazoGuerrero.agregarCarta(
                new Carta("Ira", "Mejora permanente Berserk; Gastar", 3, null, null, new Berserk(-1), null));
    ...
    public Mazo crearMazoAlquimista() {
        ...
        // Ataques
        MazoAlquimista
                .agregarCarta(new Carta("Dardo Tóxico", "Daño 1; Inflige 1 Veneno", 1, new DañoNormal(1), null,
                        new Veneno(1), null));

        MazoAlquimista
                .agregarCarta(new Carta("Frasco de Toxinas", "Inflige 3 Veneno", 2, null, null, new Veneno(3), null));
        ...
        MazoAlquimista
                .agregarCarta(new Carta("Veneno destilado",
                        "Cura igual a los efectos negativos que tenga el oponente; Roba 1 carta", 1, null, null,
                        null, null)); // TODO
